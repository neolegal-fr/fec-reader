...
public enum NatureFormulaire {
        ...
        DGFIP_2054_ECARTS_REEVALUATION(2054, "bis", "2054 bis-SD", "15949",
                        "TABLEAU DES ECARTS DE REEVALUATION SUR IMMOBILISATIONS AMORTISSABLES",
                        RegimeImposition.REEL_NORMAL, false,
                        false, null),
        ...
        DGFIP_2058_C_AFFECTATION_RESULTAT(2058, "C", "2058-C-SD", "15949",
                        "TABLEAU D'AFFECTATION DU RESULTAT ET RENSEIGNEMENTS DIVERS", RegimeImposition.REEL_NORMAL,
                        false, false,
                        null),
        DGFIP_2059_E_DETERMINATION_EFFECTIFS(2059, "E", "2059-E-SD", null,
                        "DÉTERMINATION DES EFFECTIFS ET DE LA VALEUR AJOUTÉE", RegimeImposition.REEL_NORMAL, false,
                        true,
                        null),
        ...
        DGFIP_2033_C_IMMOBILISATIONS_AMORTISSEMENTS(2033, "C", "2033-C-SD", "15948",
                        ...
                        RegimeImposition.REEL_SIMPLIFIE, false,
                        false, null),
        DGFIP_2033_D_PROVISIONS_AMORTISSEMENTS(2033, "D", "2033-D-SD", "15948",
                        "RELEVE DES PROVISIONS - AMORTISSEMENTS DEROGATOIRES - DEFICITS",
                        RegimeImposition.REEL_SIMPLIFIE, false,
                        false, null),
        DGFIP_2033_E_DETERMINATION_EFFECTIFS_ET_VALEUR_AJOUTEE(2033, "E", "2033-E-SD", null,
        ...
        DGFIP_2139_B_COMPTE_RESULTAT_SIMPLIFIE(2139, "B", "2139-B-SD", "11146",
                        "COMPTE DE RESULTAT SIMPLIFIÉ DE L'EXERCICE", RegimeImposition.REEL_SIMPLIFIE_AGRICOLE, false,
                        true, null),
        DGFIP_2072_COMPTE_RESULTAT_SIMPLIFIE(2072, "B", "2072-S-SD", "10338",
                        ...
                        RegimeImposition.REEL_SIMPLIFIE, false, true,
                        Set.of(NatureAnnexe.DETERMINATION_REVENUS_SOCIETE_IMMOBILIERE,
                                        NatureAnnexe.ASSOCIES_USUFRUITIERS_REPARTITION_RESULTAT)),
        DGFIP_2144_BILAN_ACTIF(2144, null, "2144-SD", "15947", "BILAN - ACTIF", RegimeImposition.REEL_NORMAL_AGRICOLE,
                        true,
                        true, null),
        DGFIP_2145_BILAN_PASSIF(2145, null, "2145-SD", "15947", "BILAN - PASSIF", RegimeImposition.REEL_NORMAL_AGRICOLE,
                        false,
                        false, null),
        ...
        DGFIP_2151_DETERMINATION_RESULTAt_FISCAL(2151, null, "2151-SD", "15947", "DÉTERMINATION DU RÉSULTAT FISCAL",
                        RegimeImposition.REEL_NORMAL_AGRICOLE, false, false, null),
        DGFIP_2151_BIS_RENSEIGNEMENTS_DIVERS(2151, null, "2151Bis-SD", "15947", "DEFICIT ET PROVISIONS NON DEDUCTIBLES",
                        RegimeImposition.REEL_NORMAL_AGRICOLE, false, false, null),
        DGFIP_2151_TER_RENSEIGNEMENTS_DIVERS(2151, null, "2151Ter-SD", "15947", "RENSEIGNEMENTS DIVERS",
                        RegimeImposition.REEL_NORMAL_AGRICOLE, false, false, null);
        ...
        public static Optional<NatureFormulaire> resolve(String header, boolean checkTitre) {
                ...
                for (NatureFormulaire formulaire : formulairesAvecPage) {
                        String regex = String.format(".*(%d[\\s\\-]?%s).*", formulaire.getNumero(),
                                        formulaire.getPage());
